...
class TestGetPlanField:
    ...
    def test_reimbursement_basis_r04(self):
        ...
        assert "incurred cost" in result["formatted"].lower()
    ...
    def test_reimbursement_conditions_r04(self):
        ...
        assert "prior approval" in result["formatted"].lower()
    ...
    def test_reimbursement_documents_required_r04(self):
        ...
        assert "invoice" in result["formatted"].lower() or "medical report" in result["formatted"].lower()
